 ...
 *                              disableX                               *
 ***********************************************************************/
void Vector3TextEntry::disableX()
{
   textEntry[0]->disable();
}
 ...
 *                              disableY                               *
 ***********************************************************************/
void Vector3TextEntry::disableY()
{
   textEntry[1]->disable();
}
 ...
 *                              disableZ                               *
 ***********************************************************************/
void Vector3TextEntry::disableZ()
{
   textEntry[2]->disable();
}
